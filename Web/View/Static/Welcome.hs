              ...
              <div style="max-width: 800px; margin-left: auto; margin-right: auto">
                  ...
                  <p>
                      <a
                          ...
                          style="margin-top: 2rem; background-color: red; padding: 1rem; border-radius: 3px; color: hsla(205, 69%, 98%, 1); text-decoration: none; font-weight: bold; display: inline-block; box-shadow: 0 4px 6px hsla(205, 69%, 0%, 0.08); transition: box-shadow 0.2s; transition: transform 0.2s;"
                          target="_blank"
